...
Source0:	https://github.com/pmem/%{name}/archive/refs/tags/v%{version}.tar.gz
...
%changelog
* Fri Mar 17 2023 Tom Nabarro <tom.nabarro@intel.com> - 76.1
- initial commit to daos-stack/ndctl
